...
def color_triangle_in_image(points, image):
...
#    rightmost_color = image[rightmost_point[0], rightmost_point[1]]
    ...
    print "RIGHTMOST: {}".format(rightmost_point)
    print "RIGHTMOST COLOR: {}".format(rightmost_color)

    create_rect_linear_gradient(roi, leftmost_color, rightmost_color, mask_color)
    insert_roi_into_image(roi, image, points, mask_color)
